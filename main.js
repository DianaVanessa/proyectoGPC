...
var cube = new THREE.Mesh(new THREE.BoxGeometry(1000, 2, 30), new THREE.MeshLambertMaterial({
    map: texture
}));
scene.add(cube);
...
var cubeLeft = new THREE.Mesh(new THREE.BoxGeometry(1000, 2, 10), new THREE.MeshLambertMaterial({
    map: texture3
}));
scene.add(cubeLeft);
...
var cubeRight = new THREE.Mesh(new THREE.BoxGeometry(1000, 2, 10), new THREE.MeshLambertMaterial({
    map: texture3
}));
scene.add(cubeRight);
...
function generateLights() {
    let luzAmbiente = new THREE.AmbientLight(0x000000, 0.5);
    scene.add(luzAmbiente);

    let luzPuntual = new THREE.PointLight(0x000000, 0.7);
    luzPuntual.position.set(-100, 200, -100);
    scene.add(luzPuntual);

    let luzDireccional = new THREE.DirectionalLight(0x000000, 0.3);
